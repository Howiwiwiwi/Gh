<?php 
ob_start();
$API_KEY = '5447137988:AAHCT51mjXSEkD7YRIdKKgt7Y6934BTX6w0';
...
$join = file_get_contents("https://api.telegram.org/bot".API_KEY."/getChatMember?chat_id=@Lengendvx3&user_id=".$from_id);
if($text == '/start'){
bot('sendMessage', [
'chat_id'=>$chat_id,
...
⚠️ ، معرف القناة :-  @Lengendvx3 💯

⚠️ ، معرف القناة :-  @Android_HackerX1 💯

من ثم أرسل ;- 🔘¦ قسم الويب هوك
",
]);return false;}
...
﹎﹎﹎﹎﹎﹎﹎﹎ ﹎
تابعونا على قناة لمسات برمجيه @Lengendvx3",
        'parse_mode'=>'MarkDown',
